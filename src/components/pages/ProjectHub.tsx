      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {project.internalNotes && project.internalNotes.trim() && (
              <Card className="bg-[#080d0f] border-white/5 rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-zarco-cyan/5 rounded-full blur-2xl pointer-events-none" />
                <div className="flex flex-col gap-1 mb-8 border-b border-white/5 pb-6">
                  <div className="flex items-center gap-3">
                    <span className="text-xl">📝</span>
                    <h3 className="text-xl font-black uppercase tracking-tight text-white">
                      {isPt ? "Notas de Desenvolvimento" : "Development Notes"}
                    </h3>
                  </div>
                </div>

                <div className="prose prose-invert max-w-none">
                  <p className="text-white/75 text-sm leading-relaxed whitespace-pre-line text-justify bg-[#0c1417]/50 border border-white/5 rounded-2xl p-5 font-medium">
                        ...
                        <Button
                          ...
                          onClick={async () => {
                            ...
                            try {
                              ...
                              let finalTxnId = `ch_stripe_${Math.random()
                                .toString(36)
                                .substring(2, 10)}`;
                              ...
                              try {
                                ...
                                console.log(
                                  "Client-side Firebase subscription state update succeeded."
                                );
                              } catch (dbErr) {
                                console.error(
                                  "Client-side Firebase subscription state update failed:",
                                  dbErr
                                );
                              }
                              ...
                              showToast(
                                isPt
                                  ? "Subscrição concluída com sucesso! E-mails enviados."
                                  : "Subscription activated successfully! Confirmation emails dispatched.",
                                "success"
                              );
                            } catch (err: any) {
                              console.error(err);
